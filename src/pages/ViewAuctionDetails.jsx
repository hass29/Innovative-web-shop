                  ...
                  auctionBidders.map((element, index) => {
                    return (
                      ...
                      >
                        ...
                        <p className="flex-1 text-center"> Rs. {  element.bid?.toLocaleString() || 
    element.amount?.toLocaleString() || 
    element.bidAmount?.toLocaleString() || 
    element.currentBid?.toLocaleString() || 
    element.bidPrice?.toLocaleString() || 
    element.biddingAmount?.toLocaleString() || 
    "0"}</p>
                        {index === 0 ? (
